...
public class ClassFileServer extends ClassServer {
	...
	private static String 	raiz = "/home/pablo/Descargas/root-ca-final/";
	//private static String 	raiz = "/home/pablo/Descargas/root-ca-final/sub-ca-server/";
    ...
    *****************************************************/
    ...
    if (type.equals("TLS")) 
    {
    	...
    	try {
			...
			KeyStore 			ks;
			char[] 				contraseña = "1234".toCharArray();
	
			ctx = SSLContext.getInstance("TLS");
			kmf = KeyManagerFactory.getInstance("SunX509");

			ks  = KeyStore.getInstance("JCEKS");
			ks.load(new FileInputStream(raiz + "keyStoreServidor.jce"), contraseña);
    ...
    *******************************************************/
	private static void definirKeyStores()
	{
		...
		System.setProperty("javax.net.ssl.keyStore",         raiz + "keyStoreServidor.jce");
		System.setProperty("javax.net.ssl.keyStoreType",     "JCEKS");
	    System.setProperty("javax.net.ssl.keyStorePassword", "1234");
	
	    // Almacen de confianza
	    
	    System.setProperty("javax.net.ssl.trustStore",          raiz + "trustStoreServidor.jce");
